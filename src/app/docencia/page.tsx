  ...
  return (
    <section className="container section">
      ...
      <div style={{ marginBottom: '3.5rem'}}>
        ...
        <p style={{ color: 'var(--color-muted)', lineHeight: 1.7, maxWidth: '80%' }}>Aquí comparto <a href='/proyectos' className="footer-link">proyectos</a>, <a href='https://drive.google.com/drive/folders/1PqXYl2JcU3XDW4-qsj-GjQSrGseIyu0Z?usp=drive_link' className="footer-link" target='_blank'>certificaciones</a> y <strong><a href='https://drive.google.com/file/d/1jvOzswpzRrQrDQUTKIqkm0ynfe7I478w/view' target='_blank'>experiencias</a></strong> que forman parte de este recorrido.</p>
      </div>
