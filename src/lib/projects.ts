import { Project, TeachingItem } from '@/types'
...
export const teaching: TeachingItem[] = [
  {
    ...
    description: (
      <>
       Enseño UX, diseño de interfaces y desarrollo web, integrando prototipado en Figma, programación en Javascript, WordPress, SEO y accesibilidad. También acompaño procesos de portafolio de título y práctica profesional, además de impartir cursos de especialización en tecnologías aplicadas al diseño digital.
      </>
    ),
    subjects: [
    ...
    description: (
      <>
       Hemos desarrollado proyectos de Vinculación con el Medio junto a estudiantes de 5.º semestre de Diseño Gráfico, en la asignatura “Arquitectura y Diseño de Interfaces”, creando propuestas de rediseño web desde una perspectiva centrada en los usuarios. Estos proyectos conectaron el aprendizaje del aula con desafíos reales, siendo reconocidos por su impacto y aporte.
      </>
    ),
    subjects: [
      'Fundación Gantz',
  ...
  {
    title:       'Registro de proyectos de estudiantes', 
    institution: 'Escuela de Diseño Duoc UC',
    period:      '2024 a la fecha',
    description: (
      <>
       Registros de trabajos de estudiantes en Behance de asignaturas de las carreras de Diseño Gráfico mención Interefaces e Interacciones y Desarrollo y Diseño Web a partir de los años 2024 hasta la actualidad.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
       Apoyo docente en el desarrollo, construción y evaluación de maletas didácticas para asignaturas de las carreras de Diseño Gráfico y Desarrollo Web
      </>
    ),
  },
]
